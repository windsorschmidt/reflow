...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, BT_EN_Pin|STATUS_LED_Pin|SERVO_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, OLED_DC_Pin|OLED_RESET_Pin|FAN_TACH_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : ZERO_CROSS_Pin BUTTON_NEXT_Pin BUTTON_SET_Pin BUTTON_PREV_Pin 
                           BUTTON_PANIC_Pin */
  GPIO_InitStruct.Pin = ZERO_CROSS_Pin|BUTTON_NEXT_Pin|BUTTON_SET_Pin|BUTTON_PREV_Pin 
                          |BUTTON_PANIC_Pin;
